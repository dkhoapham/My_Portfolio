        ...
        <div className="biography">
          ...
          <div className="profileAbout">
            ...
            <p className="profileAboutPara">
              ...
              <strong>Software Engineering</strong>. I'm passionate about building <strong>clean, intuitive, and reliable applications</strong>. My
              idea was driven by <em>curiosity</em> and <em>innovation</em>, and at the end of the day, I'm happy to turn it into a{" "}
              ...
              and <strong>intentional design</strong>. As a software engineering student, I use my growing knowledge of{" "}
              <strong>software design</strong>, <strong>problem-solving</strong>, and <strong>systems thinking</strong> to break down issues and
              create solutions that improve how people interact with technology.
              <br />
